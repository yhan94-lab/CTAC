...
class WeTr(nn.Module):
    def __init__(self, backbone, num_classes=None, embedding_dim=256, stride=None, pretrained=None, pooling=None,):
        ...
        if pretrained:
            ...
            model_path = os.path.join('.',parent_dir, 'pretrained', 'mit_b1.pth')
    ...
    def forward(self, x, cam_only=-1, seg_detach=True, register_hook=False):

        _x, _attns = self.encoder(x,register_hook=register_hook)
        _x1, _x2, _x3, _x4 = _x
